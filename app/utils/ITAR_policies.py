...
Technical Data means any information for the design, development, assembly, production, manufacture, operation, repair, testing, maintenance, or modification of a defense article. Technical data may include blueprints, drawings or assembly instructions, operations and maintenance manuals, and email or telephone exchanges where such information is discussed. However, technical data does not include general scientific, mathematical, or engineering principles commonly taught in schools, information present in the public domain, general system descriptions, or basic marketing information on function or purpose.

Defense Service means providing assistance, including training, to a foreign person, whether in the United States or abroad in the design, development, engineering, manufacture, production, assembly, testing, repair, demilitarization, destruction, processing, or operation of a defense article, as well as providing technical data. Defense services also include informal collaboration, conversations, or interchanges concerning technical data.
...
University employees should contact the University Export Control Officer (UECO) when classifying an item. If the University of Pittsburgh needs to obtain a CJ determination, the UECO, in conjunction with the Office of University Counsel (OUC), will file the CJ request with DDTC.
...
Exemptions: These are authorizations in the ITAR that allow for the export of unclassified hardware, technical data or defense services as described in the ITAR, without obtaining any further written approval from DDTC.
...
F. Embargoes Countries Under DDTC Regulations 
...
See also paragraph (n) of this section.
...
See also paragraph (p) of this section.
...
(1) It is the policy of the United States to deny licenses or other approvals for exports or imports of defense articles and defense services destined for or originating in Haiti, except that a license or other approval may be issued, on a case-by-case basis, for:
